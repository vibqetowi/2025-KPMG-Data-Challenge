...
(2002055111, N'Nexus', 1000017024);
    COMMIT TRANSACTION;
    PRINT 'Committed 1 records for engagements';
END TRY
BEGIN CATCH
    IF @@TRANCOUNT > 0
        ROLLBACK TRANSACTION;
...
(2002055111, 10, N'Admin', 2500000.00);
    COMMIT TRANSACTION;
    PRINT 'Committed 1 records for phases';
END TRY
BEGIN CATCH
    IF @@TRANCOUNT > 0
        ROLLBACK TRANSACTION;
...
(N'TCPI', N'To Complete Performance Index - The cost performance that must be achieved to complete remaining work within budget');
    COMMIT TRANSACTION;
    PRINT 'Committed 1 records for dictionary';
END TRY
BEGIN CATCH
    IF @@TRANCOUNT > 0
        ROLLBACK TRANSACTION;
...
-- INSERT statements for staffing table (1 records)
PRINT 'Inserting data into staffing table (1 records)...';
BEGIN TRY
    BEGIN TRANSACTION;
    -- Batch 1/1
...
(14537, 2002055111, 10, CONVERT(DATE, '2024-12-30', 120), 24.00);
    COMMIT TRANSACTION;
    PRINT 'Committed 1 records for staffing';
END TRY
BEGIN CATCH
    IF @@TRANCOUNT > 0
        ROLLBACK TRANSACTION;
...
-- INSERT statements for timesheets table (2 records)
PRINT 'Inserting data into timesheets table (2 records)...';
BEGIN TRY
    BEGIN TRANSACTION;
    -- Batch 1/2
...
(14537, 2002055111, 10, CONVERT(DATE, '2024-12-06', 120), 4.00, CONVERT(DATE, '2024-12-06', 120), CONVERT(DATE, '2024-12-06', 120), 388.00, 1552.00, 23.28);
    COMMIT TRANSACTION;
    PRINT 'Committed 2 records for timesheets';
END TRY
BEGIN CATCH
    IF @@TRANCOUNT > 0
        ROLLBACK TRANSACTION;
...
-- INSERT statements for vacations table (1 records)
PRINT 'Inserting data into vacations table (1 records)...';
BEGIN TRY
    BEGIN TRANSACTION;
    -- Batch 1/1
    INSERT INTO [dbo].[vacations] ([personnel_no], [start_date], [end_date]) VALUES
(14523, CONVERT(DATE, '2025-03-10', 120), CONVERT(DATE, '2025-03-17', 120)),
(14524, CONVERT(DATE, '2025-07-01', 120), CONVERT(DATE, '2025-07-15', 120)),
(14525, CONVERT(DATE, '2025-08-03', 120), CONVERT(DATE, '2025-08-17', 120)),
(14526, CONVERT(DATE, '2025-10-20', 120), CONVERT(DATE, '2025-10-27', 120)),
(14529, CONVERT(DATE, '2025-12-22', 120), CONVERT(DATE, '2025-12-31', 120)),
(14528, CONVERT(DATE, '2025-03-10', 120), CONVERT(DATE, '2025-03-17', 120));
    COMMIT TRANSACTION;
    PRINT 'Committed 1 records for vacations';
END TRY
BEGIN CATCH
    IF @@TRANCOUNT > 0
        ROLLBACK TRANSACTION;
