...
-- Generation timestamp: 2025-03-28 17:00:29
...
BEGIN TRY
    BEGIN TRANSACTION;
    -- Batch 1/1
    INSERT INTO [dbo].[engagements] ([eng_no], [eng_description], [client_no], [primary_practice_id])
    VALUES
...
BEGIN TRY
    BEGIN TRANSACTION;
    -- Batch 1/1
    INSERT INTO [dbo].[phases] ([eng_no], [eng_phase], [phase_description], [budget])
    VALUES
...
BEGIN TRY
    ...
    -- Batch 1/1
    INSERT INTO [dbo].[staffing] ([id], [personnel_no], [eng_no], [eng_phase], [week_start_date], [planned_hours])
    VALUES
